...
@WebServlet(urlPatterns = "/student/luudangkikihe")
public class StudentLuuDangKiKiHe extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/student/view//user/luudangkikihe.jsp").forward(req, resp);
	}
}
